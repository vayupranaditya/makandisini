	...
	"
		...
		<html xmlns='http://www.w3.org/1999/xhtml'>
			...
			<body style='background-color:#555'>
				<div class='header' style='height:50px; width:100%; margin:0px;'>
					...
					<div class='col-md-5 pencarian pull-right'>
						<form action='cari_makanan.php' method='GET' style='position:relative; top:5px; right:10px;'>
				...
				<img src='../images/under_maintenance.png' style='background-size:cover; position:relative; top:150px; left:10%; width:1000px;'/>
			</body>
		</html>
	";
?>